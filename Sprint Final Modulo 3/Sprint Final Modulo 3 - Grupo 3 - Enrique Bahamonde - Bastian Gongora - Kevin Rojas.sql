...
-- TABLAS INTERMEDIAS, VISTO QUE EXISTEN RELACIONES MUCHOS A MUCHOS SE CREAN ESTAS TABLAS PARA NORMALIZAR LA BASE DE DATOS.
...
-- INSERT 5 PRODUCTO_CLIENTE
  
  INSERT INTO producto_cliente (id_producto,rut_cliente) values 
('P1','11111111-1'),
('P2','22222222-2'),
('P3','33333333-3')
;
